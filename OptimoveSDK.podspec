#
#  Be sure to run `pod spec lint OptimoveSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Elkana Orbach"
  # s.authors            = { "Elkana Orbach" => "optimove.develop.mobile@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Elkana Orbach"
